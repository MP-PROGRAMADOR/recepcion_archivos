        ...
        <div class="cv-section mb-4 p-3 rounded bg-light">
            <div class="row align-items-center">
                ...
                <div class="col-md-9">
                    ...
                    <p class="mb-1"><i class="bi bi-key-fill me-1 text-secondary"></i><strong>Código:</strong>
                        <?= $estudiante['codigo_acceso'] ?></p>
                    <p class="mb-1"><i class="bi bi-envelope-fill me-1 text-secondary"></i><strong>Correo:</strong>
                        <?= htmlspecialchars($estudiante['email']) ?: 'No registrado' ?></p>
                    <p class="mb-0"><i class="bi bi-telephone-fill me-1 text-secondary"></i><strong>Teléfono:</strong>
