            ...
            <form id="uploadForm" action="../php/subir_foto.php" method="POST" enctype="multipart/form-data" novalidate>
                ...
                <div class="mb-3">
                    ...
                    <input type="email" class="form-control" id="email" name="email"
                        placeholder="Ej: estudios@gmail.com" required>
                ...
                <div class="mb-3">
                    ...
                    <input type="tel" class="form-control" id="telefono" name="telefono" placeholder="+1 XXX XXX XXX"
                ...
                <div class="mb-3">
                    <label for="carrera" class="form-label">
                        <i class="bi bi-mortarboard-fill me-1"></i> ¿Qué carrera estudias?
                    </label>
                    <input type="text" class="form-control" id="carrera_actual" name="carrera_actual"
                        placeholder="Ej: Ingeniería Informática" required>
                    <div class="invalid-feedback">
                        Por favor, indica la carrera que estudias.
                    </div>
                </div>
                ...
                <div class="mb-3">
                    <label for="ciudad" class="form-label">
                        <i class="bi bi-geo-alt-fill me-1"></i> ¿En qué ciudad estás?
                    </label>
                    <input type="text" class="form-control" id="ciudad_actual" name="ciudad_actual"
                        placeholder="Ej: Malasia" required>
                    <div class="invalid-feedback">
                        Por favor, indica la ciudad en la que estás.
                    </div>
                </div>
        ...
        fotoInput.addEventListener('change', () => {
            ...
            if (file) {
                ...
                reader.onload = e => {
                    ...
                    // Ocultar el spinner de carga después de que la imagen se haya cargado
